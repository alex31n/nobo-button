...
//import android.support.annotation.RequiresApi;
 ...
 class NoboButton_2 extends LinearLayout {
	...
	public NoboButton_2(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
	...
	public NoboButton_2(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public NoboButton_2(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
